import { BUSINESS, callLink, mapLink, gmailLink } from "../config/business";
import Logo from "../assets/logo/logo.jpg";
import { FaInstagram, FaFacebookF, FaYoutube, FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaClock } from "react-icons/fa";
        ...
        <div className="pg-footer-wrap">
          <div className="pg-footer-grid">
            ...
            <div className="pg-footer-col">
              ...
              <a className="pg-contact-item" href={mapLink} target="_blank" rel="noreferrer">
                <FaMapMarkerAlt />
                <span>{BUSINESS.address}</span>
              </a>

              <a className="pg-contact-item" href={callLink}>
                <FaPhoneAlt />
                <span>+91 {BUSINESS.phone}</span>
              </a>

              <a className="pg-contact-item" href={gmailLink()} target="_blank" rel="noreferrer">
                <FaEnvelope />
